...
ENV DOMAIN_URL_=$DOMAIN_URL
ENV PUBLIC_URL='/dashboard'
ENV REACT_APP_TRAJECTORY_SERVER='wss://${DOMAIN_URL_}/trajectory'
ENV REACT_APP_RMF_SERVER='https://${DOMAIN_URL_}/rmf/api/v1'
ENV REACT_APP_AUTH_PROVIDER='keycloak'
ENV REACT_APP_KEYCLOAK_CONFIG='{"realm": "rmf-web", "clientId": "dashboard", "url" : "https://${DOMAIN_URL_}/auth"}'
