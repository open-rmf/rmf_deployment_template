...
COPY --from=builder /usr/lib/x86_64-linux-gnu/ /lib64/
COPY --from=builder /usr/lib/x86_64-linux-gnu/ /usr/lib/
COPY --from=builder /usr/lib/x86_64-linux-gnu/ /usr/lib/x86_64-linux-gnu/
COPY --from=builder /usr/lib/x86_64-linux-gnu/blas/ /usr/lib/
COPY --from=builder /usr/lib/x86_64-linux-gnu/lapack/ /usr/lib/
COPY --from=builder /usr/local/bin/uvicorn /usr/local/bin/
COPY --from=builder /usr/local/lib/python3.8/dist-packages /usr/local/lib/python3.8/dist-packages/
COPY --from=builder /usr/local/lib/python3.8/dist-packages /usr/local/lib/python3.8/dist-packages/
COPY --from=builder /usr/share/proj /usr/share/proj/
COPY --from=builder /usr/lib/libgdal* /usr/lib/libarmadillo* /usr/lib/libmfhdfalt* /usr/lib/libdfalt* /usr/lib/libogdi* /usr/lib/
#COPY --from=builder /usr/lib/*.so* /usr/lib/

ENV LD_LIBRARY_PATH="/rmf_demos_ws/install/ros_ign_bridge/lib:/rmf_demos_ws/install/ros_ign_interfaces/lib:/rmf_demos_ws/install/rmf_workcell_msgs/lib:/rmf_demos_ws/install/rmf_fleet_adapter/lib:/rmf_demos_ws/install/rmf_task_ros2/lib:/rmf_demos_ws/inst\
...
_ws/install/nlohmann_json_schema_validator_vendor/lib:/rmf_demos_ws/install/menge_vendor/lib:/usr/lib/x86_64-linux-gnu/gazebo-11/plugins:/opt/ros/galactic/opt/yaml_cpp_vendor/lib:/opt/ros/galactic/opt/rviz_ogre_vendor/lib:/opt/ros/galactic/lib/x86_64-linux-gnu\
:/opt/ros/galactic/lib"
ENV PATH="/rmf_demos_ws/install/rmf_traffic_editor/bin:/rmf_demos_ws/install/nlohmann_json_schema_validator_vendor/bin:/opt/ros/galactic/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
