...
DASHBOARD_LOCAL_BUILD_ARGS="--build-arg=RMF_WEB_COMMIT=$RMF_WEB_COMMIT --build-arg=REACT_APP_TRAJECTORY_SERVER=ws://localhost:8006 --build-arg=REACT_APP_RMF_SERVER=http://localhost:8000 --build-arg=REACT_APP_AUTH_PROVIDER= --build-arg=REACT_APP_KEYCLOAK_CONFIG="
